...
import { encodeRouteToPath as encodeV3RouteToPath } from '@maxosllc/v3-sdk';
import {
  encodeRouteToPath as encodeV4RouteToPath,
  Pool as V4Pool,
} from '@maxosllc/v4-sdk';
  ...
  constructor(
    ...
    protected metricsPrefix: (
      ...
      optimisticCachedRoutes
        ...
        useMixedRouteQuoter
          ? `ChainId_${chainId}_${protocol}RouteQuoter${mixedRouteContainsV4Pool ? 'V2' : 'V1'
